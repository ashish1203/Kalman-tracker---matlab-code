% extracts the center (currx,curry) and radius of the largest blob
function [currx,curry,radius,flag]=extractball(Imwork,Imback,index)%,fig1,fig2,fig3,fig15,index)
